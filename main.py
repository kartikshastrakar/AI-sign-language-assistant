...
while True:
    ...
    cv2.putText(frame, "Ai sign Language Assistant ", (0, 100), cv2.FONT_HERSHEY_COMPLEX, 1, (0, 0, 255), lineType=cv2.LINE_AA)
    cv2.putText(frame, "by Kartik ", (400, 150), cv2.FONT_HERSHEY_COMPLEX, 1, (0, 0, 255), lineType=cv2.LINE_AA)
